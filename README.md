...
The language directory setting help switch language of your Nuxt app. 
...
This directory contains files customize directive, filter, helper of your Nuxt app. 
